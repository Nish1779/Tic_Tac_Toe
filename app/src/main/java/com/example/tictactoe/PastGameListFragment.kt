...
import com.example.tictactoe.listdata.PastGameListData
import com.example.tictactoe.listdata.PastGameListData.PastGame

/**
 * A fragment representing a list of Items.
 * Activities containing this fragment MUST implement the
 * [PastGameListFragment.OnListFragmentInteractionListener] interface.
 */
class PastGameListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_pastgamelist_list, container, false)
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onListFragmentInteraction(item: PastGame?)
    }
